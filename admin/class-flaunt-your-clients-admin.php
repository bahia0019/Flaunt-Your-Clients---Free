 ...
 * Flaunt Your Clients.
 *
 * @package   Flaunt Your Clients_Admin
...
class Plugin_Name {
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_options_page(
			...
			__( 'Flaunt Your Studio', $this->plugin_slug ),
			'manage_options',
			$this->plugin_slug,
 ...
 */
		...
		$this->plugin_screen_hook_suffix = add_menu_page( 'Flaunt Your Studio', 'Flaunt Your Studio', 'manage_options', $this->plugin_slug, array( $this, 'display_plugin_admin_page' ), plugins_url( 'assets/admin-icon-20.png', __FILE__ ), '60' );
